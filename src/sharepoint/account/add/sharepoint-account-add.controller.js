  ...
  .controller('SharepointAccountAddCtrl', class SharepointAccountAddCtrl {
    ...
    submit() {
      const getOrderUrl = this.isProvider
        ? this.sharepointLicense.getSharepointProviderNewAccountOrderUrl.bind(this.sharepointLicense)
        : this.sharepointLicense.getSharepointStandaloneNewAccountOrderUrl.bind(this.sharepointLicense);
